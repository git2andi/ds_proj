...
description: Offline-tested P0 prompt/routing checkpoint; broad GPT validation blocked by KF23 setup failures
metadata:
  node_type: memory
  type: project
---
